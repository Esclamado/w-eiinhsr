        ...
        <div class="card" style="box-shadow: 1px 1px 2px lightblue;">
            <div class="card-header">
                <div class="d-flex justify-content-between mb-3 mt-3">
                    ...
                    <div class="d-flex">
                        <div class="mr-3">
                            <a href="{{ route('upload_grades.third_year.index') }}" class="btn btn-primary">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div>
                            ...
                            @if( $student_details->grade_school=='3')
                ...
                @if($check_upload_grades)
                    ...
                    <hr style="border: 1px solid #bdbdbd">
                     ...
                     <form action="{{ route('upload_grades.third_year.update', $edit_student_first_grading_grades->id ) }}" method="POST" enctype="multipart/form-data">
                     @csrf
                        <div>
                        ...
                        <div class="row mt-3">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label style="font-size: smaller;">Enhanced Algebra Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_first_grading_grades->enhanced_algebra }}" type="text" name="enhanced_algebra" id="enhanced_algebra" class="form-control" placeholder="Enhanced Algebra" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                @if($student_details->student_type=='1')
                                <div class="form-group">
                                    <label style="font-size: smaller;">Advance Chemistry Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_first_grading_grades->advance_chemistry }}" type="text" name="advance_chemistry" id="advance_chemistry" class="form-control" placeholder="Advance Chemistry" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
                    ...
                    <form action="{{ route('upload_grades.third_year.update', $edit_student_second_grading_grades->id ) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <div>
                        ...
                        <div class="row mt-3">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label style="font-size: smaller;">Mathematics  Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_second_grading_grades->mathematics }}" type="text" name="mathematics" id="mathematics" class="form-control" placeholder="Mathematics" maxlength="50">
                                        <!-- @if ($errors->has('english_one'))
                                            <span class="text-danger text-left">{{ $errors->first('english_one') }}</span>
                                        @endif -->
                                    </div>
                                ...
                                <div class="form-group">
                                    <label style="font-size: smaller;">Enhanced Algebra Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_second_grading_grades->enhanced_algebra }}" type="text" name="enhanced_algebra" id="enhanced_algebra" class="form-control" placeholder="Enhanced Algebra" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label style="font-size: smaller;">Advance Chemistry Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_second_grading_grades->advance_chemistry }}" type="text" name="advance_chemistry" id="advance_chemistry" class="form-control" placeholder="Advance Chemistry" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
                    ...
                    <form action="{{ route('upload_grades.third_year.update', $edit_student_third_grading_grades->id ) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <div>
                        ...
                        <div class="row mt-3">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label style="font-size: smaller;">Enhanced Algebra Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_third_grading_grades->enhanced_algebra }}" type="text" name="enhanced_algebra" id="enhanced_algebra" class="form-control" placeholder="Enhanced Algebra" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label style="font-size: smaller;">Advance Chemistry Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_third_grading_grades->advance_chemistry }}" type="text" name="advance_chemistry" id="advance_chemistry" class="form-control" placeholder="Advance Chemistry" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
                    ...
                    <form action="{{ route('upload_grades.third_year.update', $edit_student_fourth_grading_grades->id ) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <div>
                        ...
                        <div class="row mt-3">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label style="font-size: smaller;">Enhanced Algebra Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_fourth_grading_grades->enhanced_algebra }}" type="text" name="enhanced_algebra" id="enhanced_algebra" class="form-control" placeholder="Enhanced Algebra" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label style="font-size: smaller;">Advance Chemistry Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_fourth_grading_grades->advance_chemistry }}" type="text" name="advance_chemistry" id="advance_chemistry" class="form-control" placeholder="Advance Chemistry" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
