        ...
        <div class="card" style="box-shadow: 1px 1px 2px lightblue;">
            <div class="card-header">
                <div class="d-flex justify-content-between mb-3 mt-3">
                    ...
                    <div class="d-flex">
                        <div class="mr-3">
                            <a class="btn btn-primary" href="{{ URL::to('/upload_grades/first_year/view_pdf', $view_student_details->student_id) }}">Export to PDF</a>
                        </div>
                        <div>
                    ...
                    <table class="table table-responsive-lg mb-0">
                        ...
                        @forelse ($view_grade_students as $view_grade_student)
                            <tr>
                                ...
                                <!-- <td class="text-center mb-1 mt-2" style="font-weight: 800"> {{ round(($view_grade_student->mathematics +  $view_grade_student->science + $view_grade_student->english + 
                                    $view_grade_student->ap + $view_grade_student->esp + $view_grade_student->filipino + $view_grade_student->tle + $view_grade_student->music + 
                                    $view_grade_student->arts + $view_grade_student->pe + $view_grade_student->health + $view_grade_student->research) / 12), 2 }} 
                                </td> -->
                                @endif
                                <!-- @if($view_student_details->student_type=='2')
                                <td class="text-center mb-1 mt-2" style="font-weight: 800"> {{ round(($view_grade_student->mathematics +  $view_grade_student->science + $view_grade_student->english + 
                                    $view_grade_student->ap + $view_grade_student->esp + $view_grade_student->filipino + $view_grade_student->tle + $view_grade_student->music + 
                                    $view_grade_student->arts + $view_grade_student->pe + $view_grade_student->health) / 11), 2 }} 
                                </td>
                                @endif -->
                            </tr>
                        @empty
