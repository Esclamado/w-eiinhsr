    ...
    <div class="py-5 container-fluid">
        ...
        <div class="card" style="box-shadow: 1px 1px 2px lightblue;">
            <div class="card-header">
                ...
                <form action="{{ route('upload_grades.fourth_year.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div>
                ...
                <div class="row mt-3">
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input type="text" name="advance_physics" id="advance_physics" class="form-control" placeholder="Advance Physics" maxlength="50">
                                @if ($errors->has('advance_physics'))
                                    <span class="text-danger text-left">{{ $errors->first('advance_physics') }}</span>
                                @endif
                            </div>
                        </div>
                        @endif
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input type="text" name="calculus" id="calculus" class="form-control" placeholder="Calculus" maxlength="50">
                                @if ($errors->has('calculus'))
                                    <span class="text-danger text-left">{{ $errors->first('calculus') }}</span>
                                @endif
                            </div>
                        </div>
                        @endif
