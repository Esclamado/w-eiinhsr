        ...
        <div class="card" style="box-shadow: 1px 1px 2px lightblue;">
            <div class="card-header">
                <div class="d-flex justify-content-between mb-3 mt-3">
                    <div style="font-weight: 700; font-size: larger;">Dashboard</div>
                    ...
                    <div class="d-flex">
                        <div class="btn-group mr-3">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ route('upload_grades.first_year.index') }}">Grade 7</a>
                                <a class="dropdown-item" href="{{ route('upload_grades.second_year.index') }}">Grade 8</a>
                                <a class="dropdown-item" href="{{ route('upload_grades.third_year.index') }}">Grade 9</a>
                                <a class="dropdown-item" href="{{ route('upload_grades.fourth_year.index') }}">Grade 10</a>
                            </div>
                        </div>
                ...
                <div>
                    <form action="{{ route('admin.index') }}" method="get">
                        <div class="d-flex">
                            ...
                            <div>
                                <button href="{{ route('admin.index') }}" class="btn btn-danger">Reset</button>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <table class="table table-responsive-lg mb-0">
                        ...
                        @forelse ($enrollments as $enrollment)
                            <tr>
                                ...
                                <td>
                                    @if($enrollment->grade_school=='1')
                                        <span class="badge badge-dark mb-1">Grade 7</span>
                                    @elseif($enrollment->grade_school=='2')
                                        <span class="badge badge-dark mb-1">Grade 8</span>
                                    @elseif($enrollment->grade_school=='3')
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.view', $enrollment->id) }}" class="btn btn-primary shadow btn-xs sharp me-1" title="View">
                                    ...
                                    <a href="{{ route('admin.edit', $enrollment->id) }}" class="btn btn-primary shadow btn-xs sharp me-1" title="Edit">
                                    ...
                                    <a onclick="setDeleteFormAction( {{$enrollment}} )" data-toggle="modal" data-target="#exampleModal" class="btn btn-danger shadow btn-xs sharp me-1" title="Delete">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="deleteForm" method="post" action="" class="tabs-wrap">
                @csrf
                    <div class="modal-body">
                        <div class="text-center" style="font-weight: 600; color: #000; font-size: 18px;">
...
<script>
    ...
    let selectedUsers;
    function setDeleteFormAction(enrollment){
        selectedUsers = enrollment;
        console.log(selectedUsers)
        let fname = selectedUsers.first_name;
        let lname = selectedUsers.last_name;
        let id = selectedUsers.id;
        var url = baseUrl + '/admin/delete_student/' + id;
        document.getElementById("user_fname").innerHTML = fname.concat(" ", lname) ;
