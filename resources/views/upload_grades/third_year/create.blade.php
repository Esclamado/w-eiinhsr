    ...
    <div class="py-5 container-fluid">
        ...
        <div class="card" style="box-shadow: 1px 1px 2px lightblue;">
            <div class="card-header">
                ...
                <form action="{{ route('upload_grades.third_year.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div>
                ...
                <div class="row mt-3">
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input type="text" name="enhanced_algebra" id="enhanced_algebra" class="form-control" placeholder="Enhanced Algebra" maxlength="50">
                                @if ($errors->has('enhanced_algebra'))
                                    <span class="text-danger text-left">{{ $errors->first('enhanced_algebra') }}</span>
                                @endif
                            </div>
                        </div>
                        @endif
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input type="text" name="advance_chemistry" id="advance_chemistry" class="form-control" placeholder="Advance Chemistry" maxlength="50">
                                @if ($errors->has('advance_chemistry'))
                                    <span class="text-danger text-left">{{ $errors->first('advance_chemistry') }}</span>
                                @endif
                            </div>
                        </div>
                        @endif
