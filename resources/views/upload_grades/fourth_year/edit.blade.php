            ...
            <div class="card-header">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div>
                            ...
                            @if( $student_details->grade_school=='4')
                ...
                @if($check_upload_grades)
                    ...
                    <hr style="border: 1px solid #bdbdbd">
                     ...
                     <form action="{{ route('upload_grades.fourth_year.update', $edit_student_first_grading_grades->id ) }}" method="POST" enctype="multipart/form-data">
                     @csrf
                        <div>
                        ...
                        <div class="row mt-3">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label style="font-size: smaller;">Advance Physics Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_first_grading_grades->advance_physics }}" type="text" name="advance_physics" id="advance_physics" class="form-control" placeholder="Advance Physics" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                @if($student_details->student_type=='1')
                                <div class="form-group">
                                    <label style="font-size: smaller;">Calculus Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_first_grading_grades->calculus }}" type="text" name="calculus" id="calculus" class="form-control" placeholder="Calculus" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
                    ...
                    <form action="{{ route('upload_grades.fourth_year.update', $edit_student_second_grading_grades->id ) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <div>
                        ...
                        <div class="row mt-3">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label style="font-size: smaller;">Advance Physics Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_second_grading_grades->advance_physics }}" type="text" name="advance_physics" id="advance_physics" class="form-control" placeholder="Advance Physics" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label style="font-size: smaller;">Calculus Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_second_grading_grades->calculus }}" type="text" name="calculus" id="calculus" class="form-control" placeholder="Calculus" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
                    ...
                    <form action="{{ route('upload_grades.fourth_year.update', $edit_student_third_grading_grades->id ) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <div>
                        ...
                        <div class="row mt-3">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label style="font-size: smaller;">Advance Physics Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_third_grading_grades->advance_physics }}" type="text" name="advance_physics" id="advance_physics" class="form-control" placeholder="Advance Physics" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label style="font-size: smaller;">Calculus Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_third_grading_grades->calculus }}" type="text" name="calculus" id="calculus" class="form-control" placeholder="Calculus" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
                    ...
                    <form action="{{ route('upload_grades.fourth_year.update', $edit_student_fourth_grading_grades->id ) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <div>
                        ...
                        <div class="row mt-3">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label style="font-size: smaller;">Advance Physics Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_fourth_grading_grades->advance_physics }}" type="text" name="advance_physics" id="advance_physics" class="form-control" placeholder="Advance Physics" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label style="font-size: smaller;">Calculus Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_fourth_grading_grades->calculus }}" type="text" name="calculus" id="calculus" class="form-control" placeholder="Calculus" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
