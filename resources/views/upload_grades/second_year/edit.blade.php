            ...
            <div class="card-header">
                ...
                @if($check_upload_grades)
                    ...
                    <hr style="border: 1px solid #bdbdbd">
                     ...
                     <form action="{{ route('upload_grades.second_year.update', $edit_student_first_grading_grades->id ) }}" method="POST" enctype="multipart/form-data">
                     @csrf
                        <div>
                        ...
                        <div class="row mt-3">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <input value="{{ $edit_student_first_grading_grades->advance_biology }}" type="text" name="advance_biology" id="advance_biology" class="form-control" placeholder="Advance Biology" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <input value="{{ $edit_student_first_grading_grades->statistics }}" type="text" name="statistics" id="statistics" class="form-control" placeholder="Statistics" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
                    ...
                    <form action="{{ route('upload_grades.second_year.update', $edit_student_second_grading_grades->id ) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <div>
                        ...
                        <div class="row mt-3">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label style="font-size: smaller;">Advance Biology Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_second_grading_grades->advance_biology }}" type="text" name="advance_biology" id="advance_biology" class="form-control" placeholder="Advance Biology" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label style="font-size: smaller;">Statistics Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_second_grading_grades->statistics }}" type="text" name="statistics" id="statistics" class="form-control" placeholder="Statistics" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
                    ...
                    <form action="{{ route('upload_grades.second_year.update', $edit_student_third_grading_grades->id ) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <div>
                        ...
                        <div class="row mt-3">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label style="font-size: smaller;">Advance Biology Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_third_grading_grades->advance_biology }}" type="text" name="advance_biology" id="advance_biology" class="form-control" placeholder="Advance Biology" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label style="font-size: smaller;">Statistics Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_third_grading_grades->statistics }}" type="text" name="statistics" id="statistics" class="form-control" placeholder="Statistics" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
                    ...
                    <form action="{{ route('upload_grades.second_year.update', $edit_student_fourth_grading_grades->id ) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <div>
                        ...
                        <div class="row mt-3">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label style="font-size: smaller;">Advance Biology Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_fourth_grading_grades->advance_biology }}" type="text" name="advance_biology" id="advance_biology" class="form-control" placeholder="Advance Biology" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label style="font-size: smaller;">Statistics Subject</label>
                                    <div class="">
                                        <input value="{{ $edit_student_fourth_grading_grades->statistics }}" type="text" name="statistics" id="statistics" class="form-control" placeholder="Statistics" maxlength="50">
                                        <!-- @if ($errors->has('philippine_history'))
                                            <span class="text-danger text-left">{{ $errors->first('philippine_history') }}</span>
                                        @endif -->
                                    </div>
