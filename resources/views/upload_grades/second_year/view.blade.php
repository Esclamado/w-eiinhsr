        ...
        <div class="card" style="box-shadow: 1px 1px 2px lightblue;">
            <div class="card-header">
                <div class="d-flex justify-content-between mb-3 mt-3">
                    ...
                    <div class="d-flex">
                        <div class="mr-3">
                            <a class="btn btn-primary" href="{{ URL::to('/upload_grades/second_year/view_pdf', $view_student_details->student_id) }}">Export to PDF</a>
                        </div>
                        <div>
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div>
                            ...
                            @if( $view_student_details->grade_school=='2')
                    ...
                    <table class="table table-responsive-lg mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="text-wrap: nowrap"> Advance Biology </th>
                                <th class="text-center" style="text-wrap: nowrap"> Statistics </th>
                                @endif
                        ...
                        @forelse ($view_grade_students as $view_grade_student)
                            <tr>
                                ...
                                <td class="text-center"> {{ $view_grade_student->advance_biology }}</td>
                                <td class="text-center"> {{ $view_grade_student->statistics }}</td>
                                @endif
                                ...
                                <td class="text-center" style="font-weight: 800;"> {{ round(($view_grade_student->mathematics + $view_grade_student->science + $view_grade_student->english + $view_grade_student->ap + $view_grade_student->esp +
                                    ...
                                    $view_grade_student->research + $view_grade_student->advance_biology + $view_grade_student->statistics) / 14), 2 }}
                                </td>
                                @endif -->
