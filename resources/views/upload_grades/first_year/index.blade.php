        ...
        <div class="card" style="box-shadow: 1px 1px 2px lightblue;">
            <div class="card-header">
                <div class="d-flex justify-content-between mb-3 mt-3">
                    ...
                    <div style="font-weight: 700; font-size: larger;">Dashboard -  Upload Grades for Grade 7 Students</div>
                    @endif
                    @if(auth()->user()->user_access === "4")
                    <div style="font-weight: 700; font-size: larger;">Dashboard -  View Grades for Grade 7 Students</div>
                    @endif
                ...
                <div>
                    <form action="{{ route('upload_grades.first_year.index') }}" method="get">
                        <div class="d-flex">
                            ...
                            <div>
                                <button href="{{ route('upload_grades.first_year.index') }}" class="btn btn-danger">Reset</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-responsive-lg mb-0">
                        ...
                        @forelse ($enrollments as $enrollment)
                            @if($enrollment->grade_school == '1' && $enrollment->enrollment_status == '1') 
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('upload_grades.first_year.view', $enrollment->student_id) }}" class="btn btn-primary shadow btn-xs sharp me-1" title="View Grades">
                                    ...
                                    @if(auth()->user()->user_access !== "4")
                                    <a href="{{ route('upload_grades.first_year.create', $enrollment->student_id) }}" class="btn btn-primary shadow btn-xs sharp me-1" title="Upload Grades">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="12" width="12" viewBox="0 0 512 512">
                                    ...
                                    <a href="{{ route('upload_grades.first_year.edit', $enrollment->student_id) }}" class="btn btn-primary shadow btn-xs sharp me-1" title="Edit Grades">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="12" width="12" viewBox="0 0 512 512">
