...
return new class extends Migration
{
    ...
    {
        Schema::create('thirdyearuploadgrades', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('filipino_three');
            $table->string('world_history');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('thirdyearuploadgrades');
    }
};
